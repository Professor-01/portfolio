    ...
    <div class="flex w-full flex-col">
      ...
      >
        ...
        >
          ...
          intention. I craft responsive, accessible solutions that make your
...
<script setup lang="ts">
  ...
  const servicesCardProps = [
    {
      ...
      body: 'I translate Figma designs into production-ready, pixel-perfect code. I focus on responsive, mobile-first layouts with cross-browser compatibility and clean component-based architecture.',
      headings: ['Figma to Code', 'Responsive Design', 'Component Architecture'],
  ...
  `,
    ...
    {
      title: 'Banner & Marketing Design',
      body: 'I design and develop high-converting website banners, hero sections, and promotional layouts for marketing campaigns. From landing page headers to case-study pages — built for branding and lead generation.',
      headings: [
        'Hero Sections',
        'Promotional Banners',
        'Landing Page Design',
  ...
  `,
    },
    {
      ...
      body: 'Your website deserves to be fast and accessible. I optimize load times, improve UI responsiveness, and ensure WCAG-aware accessibility — making your site run smoothly across all devices and browsers.',
      headings: [
        'Speed Optimization',
        'Accessibility (a11y)',
