      ...
      <div class="relative flex w-full flex-col items-center">
        ...
        <div class="lg:column-gap spacing-t grid w-full grid-cols-12">
          ...
          >
            ...
            <p class="sr-only">
              UI/UX Developer and Frontend Specialist with strong expertise in
              HTML5, CSS3, JavaScript, and Tailwind CSS.
            </p>
            <p
              v-html="whoAmI"
              id="whoAmI"
...
<script setup lang="ts">
  ...
  const whoAmI = ref(
    'A UI/UX developer & frontend specialist, building responsive, user-centric web interfaces and high-converting designs.',
  );
