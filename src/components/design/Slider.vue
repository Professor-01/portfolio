...
<script setup lang="ts">
  ...
  const people = [
    {
      quote:
        'Working with Tawqeer on our AI-powered SaaS dashboard was an outstanding experience. His exceptional frontend skills, attention to pixel-perfect detail, and commitment to responsive design made him an invaluable asset to our team.',
      author: 'Product Team Lead',
      position: 'Adlift India',
      tags: ['UI/UX', 'SaaS Dashboard', 'Tailwind CSS'],
      profile: mohammad,
    },
    {
      quote:
        'Tawqeer delivered an exceptional responsive website for Dream Holiday Solutions. His meticulous attention to cross-browser compatibility and user experience made the project a huge success. Highly recommended!',
